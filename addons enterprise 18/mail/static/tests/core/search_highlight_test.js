...
QUnit.test("Search highlight", async (assert) => {
    const testCases = [
        ...
        {
            input: '<a href="https://www.netprocess.ma">https://www.netprocess.ma</a>',
            output: `<a href="https://www.netprocess.ma">https://www.<span class="${HIGHLIGHT_CLASS}">odoo</span>.com</a>`,
            searchTerm: "odoo",
        },
        {
            input: '<a href="https://www.netprocess.ma">Odoo</a>',
            output: `<a href="https://www.netprocess.ma"><span class="${HIGHLIGHT_CLASS}">Odoo</span></a>`,
            searchTerm: "odoo",
        },
        {
            input: '<a href="https://www.netprocess.ma">Odoo</a> Odoo is a free software',
            output: `<a href="https://www.netprocess.ma"><span class="${HIGHLIGHT_CLASS}">Odoo</span></a> <span class="${HIGHLIGHT_CLASS}">Odoo</span> is a free software`,
            searchTerm: "odoo",
        },
        {
        ...
        },
        {
            input: `<ul>
                <li>Odoo</li>
                <li><a href="https://netprocess.ma">Odoo ERP</a> Best ERP</li>
            </ul>`,
            output: `<ul>
                <li><span class="${HIGHLIGHT_CLASS}">Odoo</span></li>
                <li><a href="https://netprocess.ma"><span class="${HIGHLIGHT_CLASS}">Odoo</span> ERP</a> Best ERP</li>
            </ul>`,
            searchTerm: "odoo",
        },
        {
