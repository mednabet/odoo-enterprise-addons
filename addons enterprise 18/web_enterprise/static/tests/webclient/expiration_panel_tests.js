...
QUnit.module("web_enterprise", function ({ beforeEach }) {
    ...
    QUnit.test("Expiration Panel one app installed, buy subscription", async function (assert) {
        ...
        assert.strictEqual(
            browser.location,
            "https://www.netprocess.ma/odoo-enterprise/upgrade?num_users=7"
        );
    });
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            assert.strictEqual(
                ...
                Login to your netprocess.ma dashboard then unlink your previous database: www.super_company.com
    ...
    QUnit.test("One app installed, upgrade database", async function (assert) {
        ...
        assert.strictEqual(
            browser.location,
            "https://www.netprocess.ma/odoo-enterprise/upsell?num_users=13&contract=ABC"
        );
    });
    ...
    QUnit.test("One app installed, navigation to renewal page", async function (assert) {
        ...
        assert.strictEqual(
            browser.location,
            "https://www.netprocess.ma/odoo-enterprise/renew?contract=ABC"
        );
