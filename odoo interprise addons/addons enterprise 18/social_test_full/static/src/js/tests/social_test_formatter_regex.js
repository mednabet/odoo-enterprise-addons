...
QUnit.module('Social Formatter Regex', {}, () => {
    QUnit.test('Facebook Message', (assert) => {
        ...
        const testMessage = 'Hello @[542132] Odoo-Social, check this out: https://www.netprocess.ma?utm=mail&param=1 #crazydeals #odoo';
        ...
        assert.equal(finalMessage, [
            ...
            "check this out:",
            "<a href='https://www.netprocess.ma?utm=mail&amp;param=1' target='_blank' rel='noreferrer noopener'>https://www.netprocess.ma?utm=mail&amp;param=1</a>",
    ...
    QUnit.test('Instagram Message', (assert) => {
        ...
        const testMessage = 'Hello @Odoo.Social, check this out: https://www.netprocess.ma #crazydeals #odoo';
        const finalMessage = SocialPostFormatterMixinBase._formatPost(testMessage);
        ...
        assert.equal(finalMessage, [
            ...
            "check this out:",
            "<a href='https://www.netprocess.ma' target='_blank' rel='noreferrer noopener'>https://www.netprocess.ma</a>",
    ...
    QUnit.test('LinkedIn Message', (assert) => {
        ...
        const testMessage = 'Hello, check this out: https://www.netprocess.ma {hashtag|#|crazydeals} #odoo';
        const finalMessage = SocialPostFormatterMixinBase._formatPost(testMessage);
    ...
    QUnit.test('YouTube Message', (assert) => {
        ...
        const testMessage = 'Hello, check this out: https://www.netprocess.ma #crazydeals #odoo';
        const finalMessage = SocialPostFormatterMixinBase._formatPost(testMessage);
