...
class TestEmailParsing(MailCommon):
    ...
    def test_message_parse_extract_bounce_rfc822_headers_qp(self):
        ...
        incoming_bounce = self.format(
            ...
            email_from='MAILER-DAEMON@mailserver.netprocess.ma (Mail Delivery System)',
            email_to='bounce@xxx.netprocess.ma',
            delivered_to='bounce@xxx.netprocess.ma'
        )
    ...
    def test_routing_loop_alias(self):
        ...
        with self.mock_mail_gateway():
            self.format_and_process(
                ...
                extra='References: <test-1337-loop-detection-bounce-email@netprocess.ma>',
            )
