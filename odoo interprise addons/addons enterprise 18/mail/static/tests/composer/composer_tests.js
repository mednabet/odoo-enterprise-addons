...
QUnit.test("add an emoji after a partner mention", async () => {
    ...
    const partnerId = pyEnv["res.partner"].create({
        email: "testpartner@netprocess.ma",
        name: "TestPartner",
    });
    const channelId = pyEnv["discuss.channel"].create({
        name: "Mario Party",
...
QUnit.test("Show recipient list when there is more than 5 followers.", async () => {
    ...
    const partnerIds = pyEnv["res.partner"].create([
        { name: "test name 1", email: "test1@netprocess.ma" },
        { name: "test name 2", email: "test2@netprocess.ma" },
        { name: "test name 3", email: "test3@netprocess.ma" },
        { name: "test name 4", email: "test4@netprocess.ma" },
        { name: "test name 5", email: "test5@netprocess.ma" },
        { name: "test name 6", email: "test6@netprocess.ma" },
    ]);
    ...
    await contains("li", { text: "test1@netprocess.ma" });
    await contains("li", { text: "test2@netprocess.ma" });
    await contains("li", { text: "test3@netprocess.ma" });
    await contains("li", { text: "test4@netprocess.ma" });
    await contains("li", { text: "test5@netprocess.ma" });
    await contains("li", { text: "test6@netprocess.ma" });
