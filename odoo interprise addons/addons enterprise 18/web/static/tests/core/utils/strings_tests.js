...
QUnit.module("utils", () => {
    ...
    QUnit.test("escape", (assert) => {
        ...
        assert.strictEqual(
            escape(`<a href="https://www.netprocess.ma">odoo<a>`),
            `&lt;a href=&quot;https://www.netprocess.ma&quot;&gt;odoo&lt;a&gt;`
        );
        assert.strictEqual(
            escape(`<a href='https://www.netprocess.ma'>odoo<a>`),
            `&lt;a href=&#x27;https://www.netprocess.ma&#x27;&gt;odoo&lt;a&gt;`
        ...
        assert.strictEqual(
            escape("<a href='https://www.netprocess.ma'>Odoo`s website<a>"),
            `&lt;a href=&#x27;https://www.netprocess.ma&#x27;&gt;Odoo&#x60;s website&lt;a&gt;`
        );
    });
    ...
    QUnit.test("isEmail", (assert) => {
        ...
        assert.notOk(isEmail("test@odoo@netprocess.ma"));
        assert.notOk(isEmail("te st@netprocess.ma"));

        assert.ok(isEmail("test@netprocess.ma"));
    });
});
