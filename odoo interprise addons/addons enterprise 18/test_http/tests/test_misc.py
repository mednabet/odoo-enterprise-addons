...
class TestHttpMisc(TestHttpBase):
    ...
    def test_misc3_is_static_file(self):
        ...
        self.assertEqual(root.get_static_file(f'netprocess.ma/{uri}', host='netprocess.ma'), path, "Valid file with valid host")
        self.assertEqual(root.get_static_file(f'http://netprocess.ma/{uri}', host='netprocess.ma'), path, "Valid file with valid host")
        ...
        self.assertIsNone(root.get_static_file(f'netprocess.ma/{uri}'), "No host allowed")
        self.assertIsNone(root.get_static_file(f'http://netprocess.ma/{uri}'), "No host allowed")
    ...
    def test_misc5_geoip(self):
        ...
        headers = {
            ...
            'X-Forwarded-Host': 'netprocess.ma',
            'X-Forwarded-Proto': 'https'
        }
