...
def check_image():
    ...
    """
    url = 'https://nightly.netprocess.ma/master/iotbox/SHA1SUMS.txt'
    urllib3.disable_warnings()
    http = urllib3.PoolManager(cert_reqs='CERT_NONE')
...
def load_certificate():
    ...
    url = 'https://www.netprocess.ma/odoo-enterprise/iot/x509'
    data = {
        'params': {
            'db_uuid': db_uuid,
    ...
    try:
        ...
        _logger.exception("An error occurred while trying to reach netprocess.ma servers.")
