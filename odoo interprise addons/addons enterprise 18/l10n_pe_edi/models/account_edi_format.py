...
DEFAULT_IAP_ENDPOINT = 'https://l10n-pe-edi.api.netprocess.ma'
DEFAULT_IAP_TEST_ENDPOINT = 'https://l10n-pe-edi.test.netprocess.ma'
    ...
    def _l10n_pe_edi_get_cdr_error_messages(self):
        ...
        return {
            ...
            '154': _lt("Your RUC is not linked to Digiflow as OSE, please make sure you have follow this process in the SUNAT portal:\n"
                       ...
                       "Reference: \n"
                       "https://www.netprocess.ma/documentation/17.0/applications/finance/accounting/fiscal_localizations/localizations/peru.html#what-do-you-need-to-do"),
