...
export class SubscriptionManager {
    ...
    async buy() {
        ...
        browser.location = `https://www.netprocess.ma/odoo-enterprise/upgrade?num_users=${nbUsers}`;
    }
    /**
    ...
    async renew() {
        ...
        const url = "https://www.netprocess.ma/odoo-enterprise/renew";
    ...
    async upsell() {
        ...
        const url = "https://www.netprocess.ma/odoo-enterprise/upsell";
        const contractQueryString = enterpriseCode ? `&contract=${enterpriseCode}` : "";
