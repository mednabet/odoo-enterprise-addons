...
wTourUtils.registerWebsitePreviewTour('link_tools', {
    ...
    {
        content: "Type the link URL netprocess.ma",
        trigger: '#toolbar:not(.oe-floating) #o_link_dialog_url_input',
        run: 'text netprocess.ma'
    },
    clickOnImgStep,
    // 2. Edit the link with the link tools.
    {
        content: "Click on the newly created link",
        trigger: 'iframe .s_text_image a[href="http://netprocess.ma"]:contains("netprocess.ma")',
    },
    {
        content: "Label value should contain netprocess.ma",
        trigger: '#o_link_dialog_label_input',
        run: () => {
            if ($('#o_link_dialog_label_input').val() !== 'netprocess.ma') {
                throw new Error('Label value should contain netprocess.ma');
            }
        },
    },
    {
    ...
    },
    {
        ...
        trigger: 'iframe .s_text_image a[href="http://netprocess.ma"]:contains("odoo website_2")',
    },
    {
    ...
    {
        content: "Click again on the link",
        trigger: 'iframe .s_text_image a[href="http://netprocess.ma"]:contains("odoo website")',
    },
    {
    ...
    },
    {
        ...
        trigger: 'iframe .popover div a:contains("http://netprocess.ma")',
        run: () => {}, // It's a check.
    },
    // 5. Remove link from image.
    {
        content: "Remove link.",
        trigger: 'iframe .popover:contains("http://netprocess.ma") a .fa-chain-broken',
    },
    {
    ...
    {
        content: "Select text",
        trigger: 'iframe #wrap .s_text_image p:contains(netprocess.ma)',
        run() {
    ...
    clickOnImgStep,
    {
        ...
        trigger: "iframe .s_text_image p a[href='http://netprocess.ma']:contains('netprocess.ma')",
        run: () => null,
    },
    {
    ...
    // 7. Check that http links are not coerced to https and vice-versa.
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run: 'text https://netprocess.ma',
    },
    {
        content: "Check that link was updated",
        trigger: "iframe .s_text_image p a[href='https://netprocess.ma']:contains('netprocess.ma')",
        run: () => null,
    },
    {
        content: "Change it back http",
        trigger: "#o_link_dialog_url_input",
        run: 'text http://netprocess.ma',
    },
    {
        content: "Check that link was updated",
        trigger: "iframe .s_text_image p a[href='http://netprocess.ma']:contains('netprocess.ma')",
    ...
    wTourUtils.clickOnElement("card's text", "iframe header .s_mega_menu_cards p"),
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run: "text https://www.netprocess.ma",
    },
    {
        content: "Check nothing is lost",
        trigger: "iframe header .s_mega_menu_cards a[href='https://www.netprocess.ma']:has(img):has(h4):has(p)",
        run: () => {}, // This is a check.
    },
    ...wTourUtils.clickOnSave(),
]);
