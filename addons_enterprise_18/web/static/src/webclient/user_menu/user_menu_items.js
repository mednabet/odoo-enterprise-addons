...
function documentationItem(env) {
    const documentationURL = "https://www.netprocess.ma/documentation/17.0";
    return {
        type: "item",
        id: "documentation",
...
function odooAccountItem(env) {
    return {
        type: "item",
        id: "account",
        description: _t("My netprocess.ma account"),
        callback: () => {
            env.services
                ...
                .catch(() => {
                    browser.open("https://accounts.netprocess.ma/account", "_blank");
                });
        },
        sequence: 60,
    };
