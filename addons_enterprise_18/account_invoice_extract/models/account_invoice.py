...
PARTNER_AUTOCOMPLETE_ENDPOINT = 'https://partner-autocomplete.netprocess.ma'
OCR_VERSION = 122
...
class AccountMove(models.Model):
    ...
    def _contact_iap_extract(self, pathinfo, params):
        ...
        endpoint = self.env['ir.config_parameter'].sudo().get_param('iap_extract_endpoint', 'https://extract.api.netprocess.ma')
